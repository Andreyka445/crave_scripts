...
rm -rf device/tecno/CK7n &&
rm -rf device/tecno/mt6789-common &&
rm -rf device/tecno/CK7n-kernel &&
rm -rf vendor/tecno/CK7n &&
...
git clone https://github.com/Andreyka445/local_manifests.git -b mistos-16-ck7n .repo/local_manifests
